import{_ as d}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as o,a as e,b as s,d as a,e as r,w as c,r as t,o as u}from"./app-D4T7E0pj.js";const v={},p={href:"https://plantuml.com/",target:"_blank",rel:"noopener noreferrer"};function m(b,n){const i=t("ExternalLinkIcon"),l=t("center");return u(),o("div",null,[n[4]||(n[4]=e("h1",{id:"модель-прецедентів",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#модель-прецедентів"},[e("span",null,"Модель прецедентів")])],-1)),n[5]||(n[5]=e("p",null,"В цьому файлі необхідно перелічити всі документи, розроблені в проекті та дати посилання на них.",-1)),n[6]||(n[6]=e("p",null,[e("em",null,"Модель прецедентів повинна містити загальні оглядові діаграми та специфікації прецедентів.")],-1)),e("p",null,[n[1]||(n[1]=s("Вбудовування зображень діаграм здійснюється з використанням сервісу ")),e("a",p,[n[0]||(n[0]=s("plantuml.com")),a(i)]),n[2]||(n[2]=s("."))]),n[7]||(n[7]=r(`<p>В markdown-файлі використовується опис діаграми</p><div class="language-markdown line-numbers-mode" data-ext="md" data-title="md"><pre class="language-markdown"><code>
